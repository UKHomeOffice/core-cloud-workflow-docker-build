...
## Overview
This repository forms part of the UK Home Office Core Cloud Platform’s shared GitHub Actions tooling. It contains a reusable docker build composite GitHub Action used across the platform to maintain docker code.
...
* validate the docker build reusable action
...
* It may be mistaken for intentionally broken docker code
